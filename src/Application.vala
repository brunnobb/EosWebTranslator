...
public class Clipped.Application : Gtk.Application {
    ...
    public const string SHOW_PASTE_CMD = "com.github.brunnobb.eoswebtranslator --show-paste-window";
    ...
    construct {
        application_id = "com.github.brunnobb.eoswebtranslator";
    ...
    public override void activate () {
        ...
        manager.on_text_copied.connect ((text) => {
            ...
            if (show_notification) {
                ...
                this.send_notification ("com.github.brunnobb.eoswebtranslator.settings", notification);
            }
        });
